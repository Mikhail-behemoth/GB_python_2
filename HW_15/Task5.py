...
if __name__ == '__main__':
    ...
    # запуск с командной строки: python HW_15/Task5.py -count='3-я' -weekday='среда'
    #  запуск с командной строки: python HW_15/Task5.py -count='3-я' -weekday=3
#  запуск с командной строки: python HW_15/Task5.py -count='3-я' -weekday=3 - month=3